...
;;; (C) Copyright 1995-97, 2000, Christopher R. Vincent and John C. Mallery
;;;     All Rights Reserved.
;;;
;;;
;;;------------------------------------------------------------------- 
...
(define-preference :host-name-for-apple-talk-operation
                   ...
                   :presentation-type '(or null w3p:bounded-string) ; should accept a domain here -- JCMa 6/30/1996.
