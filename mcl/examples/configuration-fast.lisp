...
;;; Copyright 1999, 2003, John C. Mallery.
;;; All rights reserved.
;;;------------------------------------------------------------------- 
;;;
...
(if (ccl::osx-p)
   ;; less cooperative scheduling under MacOSX-- JCMa 2/23/2003.
   (setq ccl::*background-sleep-ticks* 0       ; default 5
            ccl::*foreground-sleep-ticks* 0        ;  default 0
            ccl::*foreground-event-ticks* 600    ;  default 20
            ccl::*background-event-ticks*  600)    ;  default 5
...
(setq *number-of-listening-processes* #+ccl-5.0 (if (ccl:osx-p) *number-of-listening-processes*  20) #-ccl-5.0 20) 
