...
;;;
;;; Copyright 1994-99, 2005, John C. Mallery.
;;; All rights reserved.
;;;------------------------------------------------------------------- 
;;;
...
(define-system 
  ...
  #+Open-Transport                              ; TCP - OpenTransport Native Interface PPC MCL 3.9, 4.0, 4.1, 4.2, 4.3, 4.4
  (:in-order-to-load :compile-load
  ...
  "http:server;html4"				; HTML 4.0 Generation
  ...
  #+CLIM-2"http:clim;old-ui;package"                   ; CLIM Interface Package
  #+CLIM-2"http:clim;old-ui;interface")                ; CLIM Server Interface
