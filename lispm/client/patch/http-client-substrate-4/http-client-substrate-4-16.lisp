...
;;; Patch file for HTTP-CLIENT-SUBSTRATE version 4.16
;;; Reason: Function HTTP::MAP-CLIENT-PROXIES:  new.
;;; Function HTTP::GET-CLIENT-PROXY:  -
;;; Function (CLOS:METHOD HTTP::GET-CLIENT-PROXY (URL::HOST-PORT-MIXIN)):  -
;;; Function (CLOS:METHOD HTTP::GET-CLIENT-PROXY (STRING)):  -
;;; Function HTTP::COMPUTE-STANDARD-REQUEST-HEADERS:  add proxy-authorization argument.
;;; Function (CLOS:METHOD HTTP::COMPUTE-STANDARD-REQUEST-HEADERS (URL:HTTP-URL)):  implement.
;;; Written by JCMa, 7/28/01 22:49:14
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:CLIENT;CLIENT.LISP.284")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:CLIENT;CLIENT.LISP.284")
