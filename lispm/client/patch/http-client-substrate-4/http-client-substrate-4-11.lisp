...
;;; Patch file for HTTP-CLIENT-SUBSTRATE version 4.11
;;; Reason: Function HTTP:WITH-HTTP-REQUEST:  make request handler dynamic extent too.
;;; Function HTTP::CONNECTION-DATA-RECEIVED-P:  new abstraction
;;; Written by JCMa, 5/11/01 15:00:13
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:CLIENT;CLIENT.LISP.280"
  "HTTP:CLIENT;CONNECTION.LISP.82")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:CLIENT;CLIENT.LISP.280")
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:CLIENT;CONNECTION.LISP.82")
(SCT:PATCH-SECTION-ATTRIBUTES
...
(defun connection-data-received-p (&optional (connection *connection*))
  "Returns non-null when data bas been received over CONNECTION." 
  (and connection
