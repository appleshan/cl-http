...
;;; Patch file for HTTP-CLIENT-SUBSTRATE version 4.6
;;; Reason: Add the :CL-HTTP-CLIENT feature for code conditinalization.
;;; Written by JCMa, 12/17/00 04:26:18
...
;;; HTTP Proxy Server 6.12, HTTP Client Substrate 4.5, Statice Server 466.2,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:CLIENT;CLIENT.LISP.274")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:CLIENT;CLIENT.LISP.274")
