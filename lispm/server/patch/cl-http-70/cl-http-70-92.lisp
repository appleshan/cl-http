...
;;; Patch file for CL-HTTP version 70.92
;;; Reason: Function HTTP:CURRENT-ACCESS-LOGS:  Just return the current access logs and return them all.
;;; Written by Joswig, 12/05/00 17:03:49
...
;;; HTTP Proxy Server 6.3, HTTP Server 70.91, Showable Procedures 36.3,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;LOG.LISP.201")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;LOG.LISP.201")
