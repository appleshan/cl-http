...
;;; Patch file for CL-HTTP version 70.77
;;; Reason: WWW-UTILS:WITHOUT-PREEMPTION (macro): provide portable macro for ensuring atomic execution without preemption by other processes.
;;; Written by JCMa, 9/22/00 17:40:18
...
;;; HTTP Client Substrate 3.23, Jcma 42, HTTP Proxy Server 5.31, HTTP Client 49.11,
...
;;; Domain ad host patch (from W:>reti>domain-ad-host-patch.lisp.11),
;;; Background dns refreshing (from W:>reti>background-dns-refreshing.lisp.5),
;;; Prevent reset of input buffer on tcp reset by HTTP servers. (from HTTP:LISPM;W4;RECEIVE-TCP-SEGMENT-PATCH.LISP.7),
;;; Cname level patch (from W:>Reti>cname-level-patch.lisp.2).



(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;LISPM.LISP.474")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;LISPM.LISP.474")
...
(eval-when (load eval compile)
  (mapc #'(lambda (x)
            ...
            (export x :www-utils))
        (list (intern "WITHOUT-PREEMPTION" :process))))
