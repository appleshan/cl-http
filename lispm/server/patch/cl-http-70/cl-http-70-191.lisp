...
;;; Patch file for CL-HTTP version 70.191
;;; Reason: Function HTTP::SET-LOGICAL-HOST-DIRECTORY:  New function sets the logical
;;; directory for logical hosts to physical pathnames. Useful for fine tuning
;;; initalizations.
;;; Function HTTP::SET-HTTP-LOGICAL-DIRECTORY-LOCATION:  specialized for HTTP logical host.
;;; export "SET-HTTP-LOGICAL-DIRECTORY-LOCATION".
;;; Written by jcma, 7/10/05 19:58:58
...
;;; HTTP Server 70.190, Showable Procedures 36.3, Binary Tree 34.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;UTILS.LISP.549")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;UTILS.LISP.549")
(SCT:PATCH-SECTION-ATTRIBUTES
  "-*- Syntax: Ansi-common-lisp; Package: HTTP; Base: 10; Mode: lisp -*-")

(defun set-logical-host-directory (logical-host directory physical-pathname)
  "Sets the directory, DIRECTORY, for the logical host, LOGICAL-HOST, to be PHYSICAL-PATHNAME."
  (check-type logical-host string)
  ...
  (flet ((directory-match-p (key entry key-length)
         ...
         (make-dir-spec (directory length)
           (if (char-equal #\; (aref directory (1- length)))
    ...
    (loop with directory-length fixnum = (length directory) 
          ...
          finally (push (list (make-dir-spec directory directory-length)
...
(eval-when (:load-toplevel :execute)
  (export (intern "SET-HTTP-LOGICAL-DIRECTORY-LOCATION" :http) :http))
