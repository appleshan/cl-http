...
;;; Patch file for CL-HTTP version 70.91
;;; Reason: Function HTTP::STANDARD-ACCESS-LOGS:  numeric comparison with eql
;;; Written by JCMa, 12/05/00 16:38:36
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;LOG.LISP.200")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;LOG.LISP.200")
