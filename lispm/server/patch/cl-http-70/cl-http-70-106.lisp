...
;;; Patch file for CL-HTTP version 70.106
;;; Reason: Function (CLOS:METHOD HTTP::ADVANCE-INPUT-BUFFER (TCP::TCP-MODAL-HTTP-STREAM)):  allow null buffer case when delta provided.
;;; Written by JCMa, 12/17/00 00:35:01
...
;;; Mailer 438.0, Working LispM Mailer 8.0, HTTP Server 70.105,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;TCP-LISPM-STREAM.LISP.197")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;TCP-LISPM-STREAM.LISP.197")
