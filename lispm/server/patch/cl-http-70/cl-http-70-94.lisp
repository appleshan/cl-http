...
;;; Patch file for CL-HTTP version 70.94
;;; Reason: Function (CLOS:METHOD URL:PATHNAME-FTP-URL-STRING (FS:RANDOM-PATHNAME)):  specialized method on random host
;;; Written by JCMa, 12/06/00 17:32:45
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;LISPM.LISP.482")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;LISPM.LISP.482")
...
(mapc #'scl:fundefine
	 ...
	 www-utils::with-automatic-login
	 www-utils::host-access-path-for-host-p))

(mapc #'lt:undefine-variable
      '(www-utils::*nfs-authentication-function*
	 www-utils::*standard-get-user-id-and-password*)))