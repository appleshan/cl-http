...
;;; Patch file for CL-HTTP version 70.146
;;; Reason: Function HTTP:REDIRECT-REQUEST:  update documentation.
;;; Written by JCMa, 9/06/01 16:19:01
...
;;; Mailer 438.0, Working LispM Mailer 8.0, HTTP Server 70.145,
...
;;; HTTP Proxy Server 6.25, HTTP Client Substrate 4.17, Statice Server 466.2,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;SERVER.LISP.918")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.918")
