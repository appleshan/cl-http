...
;;; Patch file for CL-HTTP version 70.141
;;; Reason: Function HTTP::%EXECUTE-REQUEST:  close connection when bad syntax in request.
;;; Written by JCMa, 8/14/01 17:59:24
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;SERVER.LISP.915")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.915")
