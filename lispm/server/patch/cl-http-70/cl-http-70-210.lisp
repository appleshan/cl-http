...
;;; Patch file for CL-HTTP version 70.210
;;; Reason: Function HTTP::WRITE-MIME-CONTENT-TYPE-AS-STRING:  correct call to write-char.
;;; Function HTTP::WRITE-MIME-CONTENT-TYPE-KEYWORD-AS-STRING:  ditto.
;;; Written by jcma, 9/10/05 00:59:41
...
;;; HTTP Server 70.209, Showable Procedures 36.3, Binary Tree 34.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;HEADERS.LISP.543")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HEADERS.LISP.543")
