...
;;; Patch file for CL-HTTP version 70.72
;;; Reason: Function (CLOS:METHOD HTTP:DEINITIALIZE-RESOURCED-SERVER (T HTTP::PROXY-SERVER-MIXIN) :AFTER):  
;;; Reset server-proxy-request-p and server-proxy-client-data on deinitialization.
;;; Written by JCMa, 9/15/00 16:08:47
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;SERVER.LISP.856")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.856")
