...
;;; Patch file for CL-HTTP version 70.109
;;; Reason: Function HTTP::%EXECUTE-REQUEST:  relativize local loop proxy requests.
;;; Written by JCMa, 1/17/01 17:00:20
...
;;; Genera 8 5 System Patches 1.22, Genera 8 5 Mailer Patches 1.1,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;SERVER.LISP.885")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.885")
  ...
  (flet ((invoke-local-service (server url-string method http-version)
	 ...
	 (nrelativize-url (string)
	   (url::with-relative-name-string-indices (string 0 (length string))
	     (copy-vector-portion string start end string 0 (- end start))	;works because we copy down
