...
;;; Patch file for CL-HTTP version 70.147
;;; Reason: Function WWW-UTILS::WITH-TCP-PORT-FOR-PROTOCOL:  fix port protocol order bug.
;;; Written by JCMa, 9/18/01 17:28:37
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;LISPM.LISP.498")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;LISPM.LISP.498")
