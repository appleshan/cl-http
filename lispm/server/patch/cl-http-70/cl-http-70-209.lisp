...
;;; Patch file for CL-HTTP version 70.209
;;; Reason: Function HTTP::WRITE-MIME-CONTENT-TYPE-KEYWORD-AS-STRING:  new
;;; DEFINE-CONDITION HTTP::HTML-GENERATION-ERROR:  new.
;;; Written by jcma, 9/04/05 17:54:24
...
;;; HTTP Server 70.208, Showable Procedures 36.3, Binary Tree 34.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;HEADERS.LISP.542"
  "HTTP:SERVER;HTTP-CONDITIONS.LISP.208")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HEADERS.LISP.542")
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HTTP-CONDITIONS.LISP.208")
(SCT:PATCH-SECTION-ATTRIBUTES
