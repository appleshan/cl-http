...
;;; Patch file for CL-HTTP version 70.150
;;; Reason: DEFINE-CONDITION HTTP::PROXY-INVALID-AUTHENTICATION-CREDENTIALS:  -
;;; Written by JCMa, 9/20/01 16:05:49
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;HTTP-CONDITIONS.LISP.203")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HTTP-CONDITIONS.LISP.203")
