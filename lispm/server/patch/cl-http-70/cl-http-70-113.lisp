...
;;; Patch file for CL-HTTP version 70.113
;;; Reason: Function URL::WITH-RELATIVE-NAME-STRING-INDICES:  automatically declare the indices.
;;; Function HTTP::%EXECUTE-REQUEST:  fix bug relatizing URL for proxy request to local server.
;;; Written by JCMa, 3/08/01 15:28:53
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.887")
(SCT:PATCH-SECTION-ATTRIBUTES
