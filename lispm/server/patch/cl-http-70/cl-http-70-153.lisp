...
;;; Patch file for CL-HTTP version 70.153
;;; Reason: Function (CLOS:METHOD HTTP::MIME-STREAM-DECODE-UNTIL-BOUNDARY (T T T (EQL :BINARY))):  
;;; Fix check-for-mime-boundry not to drop a byte on failed matches.
;;; Written by JCMa, 10/30/01 19:16:14
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;UTILS.LISP.501")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;UTILS.LISP.501")
  ...
  (macrolet ((binary-char-code (char)
    ...
    (labels ((fill-boundary-array (array boundary boundary-length)
		 ...
		 (loop for idx fixnum upfrom 1 below boundary-array-length
		       ...
		       finally (when (< idx boundary-array-length)
				 (write-array-portion to-stream boundary-array idx next-byte)
