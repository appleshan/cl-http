...
;;; Patch file for CL-HTTP version 70.200
;;; Reason: Add new export types: :lispm-reel, :asc-file, :sig-file
;;; Written by jcma, 7/30/05 15:54:32
...
;;; HTTP Server 70.199, Showable Procedures 36.3, Binary Tree 34.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;SERVER.LISP.937")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.937")
(SCT:PATCH-SECTION-ATTRIBUTES
  "-*- Mode: lisp; Syntax: ANSI-Common-Lisp; Package: http; Base: 10 -*-")

(define-url-export-types
  ;; fix conditionalizations for non-mcl mac implementations
  (:mac-binary-file :macbin (:application :x-macbinary) :copy-mode :binary
		    #+:Mac :alternate-extensions #+Mac(:bin))
  ;; handle lispm reels
