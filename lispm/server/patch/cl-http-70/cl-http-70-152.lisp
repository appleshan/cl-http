...
;;; Patch file for CL-HTTP version 70.152
;;; Reason: Function TK1::TOKENIZER-SIZE-PRIME-CEILING:  error when size exceeds available prime ceilings.
;;; Variable HTTP:*DIGEST-AUTHENTICATION-NONCE-LIFE-TIME*:  set default to 30 seconds.
;;; DEFINE-CONDITION HTTP::PROXY-INVALID-AUTHENTICATION-CREDENTIALS:  add proxy and realm.
;;; Written by JCMa, 9/28/01 14:51:23
...
;;; Patch file for CL-HTTP version 70.152
;;; Written by JCMa, 10/20/01 16:20:51
;;; while running on FUJI-VLM from FUJI:/usr/lib/symbolics/ComLink-39-8-F-MIT-8-5.vlod
;;; with Open Genera 2.0, Genera 8.5, Lock Simple 437.0, Version Control 405.0,
;;; Compare Merge 404.0, VC Documentation 401.0,
;;; Logical Pathnames Translation Files NEWEST, CLIM 72.0, Genera CLIM 72.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;TOKENIZER.LISP.59"
  "HTTP:SERVER;VARIABLES.LISP.197"
  "HTTP:SERVER;HTTP-CONDITIONS.LISP.204")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;TOKENIZER.LISP.59")
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;VARIABLES.LISP.197")
(SCT:PATCH-SECTION-ATTRIBUTES
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HTTP-CONDITIONS.LISP.204")
(SCT:PATCH-SECTION-ATTRIBUTES
