...
;;; Patch file for CL-HTTP version 70.183
;;; Reason: Function (CLOS:METHOD HTTP::EXPUNGE-DELETED-FILES NIL):  fix infinite loop bug.
;;; Fix up export-url documentation.
;;; Written by JCMa, 10/29/03 20:45:27
...
;;; HTTP Server 70.182, W3 Presentation System 8.1, HTTP Client Substrate 4.23,
;;; HTTP Client 51.6, CL-HTTP Server Interface 54.0, HTTP Proxy Server 6.34,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;LISPM.LISP.520"
  "HTTP:SERVER;SERVER.LISP.932")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;LISPM.LISP.520")
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;SERVER.LISP.932")
(SCT:PATCH-SECTION-ATTRIBUTES
