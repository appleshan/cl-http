...
;;; Patch file for CL-HTTP version 70.37
;;; Reason: Function WWW-UTILS::FTP-DIRECTORY-INFO:  return a second value indicating whether the directory exists.
;;; Written by JCMa, 5/01/00 23:38:42
...
;;; Mailer 438.0, Working LispM Mailer 8.0, HTTP Server 70.36,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LISPM;SERVER;LISPM.LISP.453")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LISPM;SERVER;LISPM.LISP.453")
...
If a network error is encountered, this returns NIL."
  ...
  (let* ((path (pathname directory))
    ...
    (with-automatic-login (host user-id user-pw)
      ...
      (let ((listing (directory-info directory)))
	(if listing
	    (values listing t)
	    (values nil (probe-directory directory)))))))
