...
;;; Patch file for CL-HTTP version 70.96
;;; Reason: Function (CLOS:METHOD URL:CANONICALIZE-URL ((EQL :HTTPS) T)):  fix prefix length bug.
;;; Written by JCMa, 12/07/00 22:43:16
...
;;; Mailer 438.0, Working LispM Mailer 8.0, HTTP Server 70.95,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;URL.LISP.421")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;URL.LISP.421")
...
(defmethod canonicalize-url ((scheme (eql :https)) url-string &optional (start 0) (end (length url-string)) destructive-p)
  (%canonicalize-host-prefixed-url "https" 5 url-string start end destructive-p))
