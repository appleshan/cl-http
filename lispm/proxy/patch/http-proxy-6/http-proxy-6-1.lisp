...
;;; Patch file for HTTP-PROXY version 6.1
;;; Reason: Function (CLOS:METHOD HTTP::RESTORE-METADATA (HTTP::FILESYSTEM-DATABASE T T) :AROUND):  fix bug.
;;; Written by JCMa, 11/16/00 00:04:54
...
;;; Jcma 42, HTTP Client Substrate 4.0, HTTP Proxy Server 6.0, HTTP Client 50.0,
;;; Image Substrate 440.4, Essential Image Substrate 433.0,
;;; W4 Constraint-Guide Web Walker 45.6, W4 Examples 15.0, Ivory Revision 5,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:PROXY;REPRESENTATION.LISP.57")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:PROXY;REPRESENTATION.LISP.57")
...
(defmethod restore-metadata :around ((database filesystem-database) pathname mode)
  (tagbody retry
	   (restart-case
	     (call-next-method database pathname mode)
	     (skip ()
