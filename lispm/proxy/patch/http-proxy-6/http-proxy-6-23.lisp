...
;;; Patch file for HTTP-PROXY version 6.23
;;; Reason: Use an iteration method over the recency list that avoids lisp-implementation-specific pitfalls.
;;; 
;;; Function (CLOS:METHOD HTTP::CACHE-RECENCY-MAP-REPRESENTATIONS (HTTP::CACHE-REFERENCE-RECENCY-MIXIN T)):  portable implementation.
;;; Function (CLOS:METHOD HTTP::CACHE-RECENCY-MAP-RESOURCES (HTTP::CACHE-REFERENCE-RECENCY-MIXIN T)):  ditto.
;;; Function HTTP::PROXY-CACHEABLE-RESPONSE-HEADER-PLIST:  -
;;; Written by JCMa, 6/06/01 12:58:32
...
;;; Patch file for HTTP-PROXY version 6.23
;;; Written by JCMa, 7/29/01 03:02:49
;;; while running on FUJI-VLM from FUJI:/usr/lib/symbolics/ComLink-39-8-F-MIT-8-5.vlod
;;; with Open Genera 2.0, Genera 8.5, Lock Simple 437.0, Version Control 405.0,
;;; Compare Merge 404.0, VC Documentation 401.0,
;;; Logical Pathnames Translation Files NEWEST, CLIM 72.0, Genera CLIM 72.0,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:PROXY;CACHE.LISP.157"
  "HTTP:PROXY;UTILS.LISP.77")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:PROXY;CACHE.LISP.157")
...
;D,#TD1PsT[Begin using 006 escapes](1 0 (NIL 0) (NIL :ITALIC NIL) "CPTFONTI");0 dolist loses the next cdr on some implementations (e.g. LispWorks) when performing reference-time
;; proxy GC beause they don't keep the pointer to the next cons outside the body. -- JCMa 5/29/2001.
