...
;;; Patch file for HTTP-PROXY version 6.25
;;; Reason: CLOS class HTTP::PROXY-EXTENDED-COMMON-LOG-ENTRY:  fix class precedence bug.
;;; Written by JCMa, 8/20/01 20:54:00
...
;;; Mailer 438.0, Working LispM Mailer 8.0, HTTP Server 70.143,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:PROXY;UTILS.LISP.78")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:PROXY;UTILS.LISP.78")
