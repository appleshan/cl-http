...
;;; Patch file for W3P version 8.2
;;; Reason: DEFINE-PRESENTATION-METHOD W3P:PRESENT:  fix view arg for null case.
;;; Written by jcma, 8/20/05 22:19:39
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:W3P;STANDARD-METHODS.LISP.17")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:W3P;STANDARD-METHODS.LISP.17")
