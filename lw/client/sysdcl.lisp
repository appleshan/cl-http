...
(sct-defsystem http-client-substrate
  ...
  (:serial
    cl-http
    #+CL-HTTP-SSL-CLIENT
    "http:lw;client;ssl"                        ;SSL client support
    #-LispWorks3.2
    "http:lw;client;tcp-stream"                 ;TCP support for FTP client
    #+Genera
    "HTTP:LISPM;CLIENT;LISPM"                   ;Network Support
    "variables"                                 ;Variables Controlling Client
    #-LispWorks3.2
    "http:lw;client;unix"                       ;client support
    #-LispWorks3.2
    "http:ftp;package"
    #-LispWorks3.2
...
(sct-defsystem http-base-client
  ...
  (:serial
    ...
    #-LispWorks3.2
    "http:ftp;shell"                            ;FTP client shell (not necessary, but useful for debugging FTP code)
...
(sct-defsystem w4-examples
    (:pretty-name "W4 Examples"
     ...
     :patchable t
     :source-category :basic
     #+Genera :required-systems #+Genera w4)
  (:module pointers
   ("sys:site;http.translations"
