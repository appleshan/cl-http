...
;; all rights reserved.
;;
;; $Id: //depot/cl-http/html-parser-11/html-4-0-strict.lisp#1 $
;;
...
(define-html-entity #e"%block"
  (:or p #e"%heading" #e"%list" #e"%preformatted" dl div
...
(define-html-element address
    :content (* #e"%inline")		; information on author
    :attributes (#e"%attrs"		; %coreattrs, %i18n, %events
		   ))
...
(define-html-element BUTTON		; push button
    :content (* #e"%flow")
    :exclusions (:or A #e"%formctrl" FORM FIELDSET)
    :attributes (#e"%attrs"		; %coreattrs, %i18n, %events
		   (name CDATA :implied)
