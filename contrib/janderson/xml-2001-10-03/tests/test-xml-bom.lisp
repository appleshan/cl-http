...
<DOCUMENTATION>
 <DESCRIPTION>
  an xml-dev posting april 2001 rasied the question as to which BOMs were recognized.
  of the test cases, one is unambiguously invalid (with ent2x.ent).
...
(setf (logical-pathname-translations "bomtest")
      `(("**;*.*" "www:Dokumente:Standards:XML:XMLConf:bomtest:**:*.*")))
