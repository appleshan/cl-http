...
(defParsetable (|Attribute|             xql-parsetable)   tag-content quote tokenized-whitespace)
(defParsetable (|AttributeValueContent| xql-parsetable)   quote attribute-value)
(defParsetable (|CdataSection|          xql-parsetable)   cdata-character-data)
(defParsetable (|ElementContent|        xql-parsetable)   element-character-data)
(defParsetable (|Expr|                  xql-parsetable)   quote expr-character-data ignored-whitespace)
(defParsetable (|CommentConstructor|    xql-parsetable)   comment-char-sequence)
(defParsetable (|PiConstructor|         xql-parsetable)   pi-char-sequence)
(defParsetable (|QueryModule|           xql-parsetable)   quote module-content ignored-whitespace)
(defParsetable (|EndTag|                xql-parsetable)   #\> tokenized-whitespace)
;; (defParsetable (|StringLiteral|         xql-parsetable)   quote-inner)
(defParsetable (|StringLiteralData|         xql-parsetable)   quote-inner)
(defParsetable (|StartTag|              xql-parsetable)   tag-content tokenized-whitespace)
           ...
           (typecase char
             (character
              ...
              (cond (macro
                     ...
                     (when (control-key-p) (print (list :macro-> token)))
                     (case token
