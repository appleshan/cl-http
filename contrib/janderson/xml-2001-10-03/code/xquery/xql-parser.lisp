...
(eval-when (:compile-toplevel)
  (let* ((*class.atn* 'xql-atn)
    ...
    (compile-atn-system #p"xml:bnf;xql-grammar.bnf"
                        :compile t
                        ;; don't load directly - the defsystem is set
                        ;; up to load after compilation
                        ;; :load t
                        :package *token-package*
                        :fasl-pathname "xml:code;atn-lib;xql-grammar.bin"
                        :source-pathname "xml:code;atn-lib;xql-grammar.lisp"
                        ;; :ambiguous t
                        :wfst t
...
(eval-when  (:load-toplevel)
  (cl-user::conditional-load-file "xml:code;atn-lib;xql-grammar"))
