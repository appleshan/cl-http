...
(defGeneric test-type-specifier (datum type-specifier)
  ...
  (:method and ((datum string) (spec xsd::enumerated-type-specifier))
           (with-slots (enumeration) spec
             (or (null enumeration)
                 (find datum enumeration :test #'string=))))
  (:method and ((datum number) (spec xsd::enumerated-type-specifier))
           (with-slots (enumeration) spec
             (or (null enumeration)
                 (find datum enumeration :test #'=))))
  (:method and ((datum sequence) (spec xsd::sequence-type-specifier))
           (with-slots (length min-length max-length)
             ...
             (cond (length
                   ...
                   (t t))))
  (:method and ((datum string) (spec xsd::pattern-type-specifier))
           (with-slots (pattern) spec
             (or (null pattern)
                 (funcall (type.pattern-predicate spec) datum))))
  (:method and ((datum null) (spec xsd::enumerated-type-specifier))
           (with-slots (enumeration) spec
             (or (null enumeration)
                 (find datum enumeration))))
  (:method and ((datum (eql t)) (spec xsd::enumerated-type-specifier))
           (with-slots (enumeration) spec
             (or (null enumeration)
                 (find datum enumeration))))
  (:method and ((datum number) (spec xsd::bounded-type-specifier))
           (with-slots (min-inclusive max-inclusive
             ...
             (and (cond (min-inclusive (<= min-inclusive datum))
                  ...
                  (cond (max-inclusive (>= max-inclusive datum))
                        ...
                        (t t)))))
  (:method and ((datum integer) (spec xsd::|decimal|))
                  ...
                  (or (null total-digits)
                           (< (ceiling (log datum 10))
                              (if fraction-digits
                                ...
                                total-digits)))))
  (:method and ((datum ratio) (spec xsd::|decimal|))
           (test-type-specifier (float datum) spec))
  (:method and ((datum float) (spec xsd::|decimal|))
           (test-type-specifier (write-to-string datum) spec))
  (:method and ((datum string) (spec xsd::|decimal|))
           (with-slots (total-digits fraction-digits) spec
                    ...
                    (let* ((position (position #\. datum))
                      ...
                      (and (cond (total-digits
                           ...
                           (cond (fraction-digits
                                 ...
                                 (t t)))))
                   (t t))))
  (:method and ((datum sequence) (spec xsd::list-type-specifier))
