...
(defParsetable (|Attribute| xml-parsetable)       tag-content tokenized-whitespace)
(defParsetable (|AttChild| xml-parsetable)        quote-context attribute-value)
(defParsetable (|AttValue| xml-parsetable)        quote-context tokenized-whitespace attribute-value)
(defParsetable (|AttDef| xml-parsetable)          #\( #\) #\| #\> pe-ref-context quote-context tokenized-whitespace attribute-value)
...
(defun token-reader
  ...
  (let* ((macros (table.macros *parsetable*))
    ...
    (declare (optimize (speed 3) (safety 0))
             ...
             (type function parse-external-subset parse-external-general-entity))
    (when bnfp::*atn-trace*
