...
;; wg. CL-Konformitaet
(defmethod documentation ((x inference-system) #-(or CMU LispWorks4) &optional type)
  (declare (ignore type))
  (slot-value x 'doc))

(defmethod (setf documentation) (doc (x inference-system) #-(or CMU LispWorks4) &optional type)
  (declare (ignore type))
