...
;; Use logical pathnames 'cause we finally groked the concept after 30 years of bliss
;; [jkf says: the author of the above comment is not me.  I strongly 
;;  dislike logical pathnames.  
;;  I apologize that this file was converted to use logical pathnames 
;;  and that I'm too busy to convert it back to something reasonable.]
;;
...
(defparameter *files-clim-sys*
    '(("http:clim;clim-sys;" "package" "process" "miniproc" "resource" "util" "demo")))
...
(defun load-test (&key (w4-examples t)
  ...
  ;;
  (let ((.files-loaded.))
    (load "http:examples;access-control.lisp")
