...
bind80 - a utility to open port 80 before starting an application
	 as a non super user having access to port 80
Linux make:
% gcc bind80.c -o bind80

Solaris make (first comment out the "#define LINUX" below):
% cc bind80.c -o bind80 -lsocket -lnsl

This is the UNIX/Solaris/Linux version of "bind80" to enable CL-HTTP
