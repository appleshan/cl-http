...
;;; Package definition from resources.lisp
...
(defpackage "MINIPROC"
  ...
  (:import-from "RESOURCES" 
        ...
        "CLEAR-RESOURCE"
        "DEALLOCATE-RESOURCE"
        ;;;#+must_match_clim-sys_api "DEFRESOURCE"
        "DESCRIBE-RESOURCE"
        ;;;#+must_match_clim-sys_api "MAP-RESOURCE"
        "MATCHING-RESOURCE"
        "RESOURCE"
        "USING-RESOURCE")
  (:export
...
;;; Methods are used so that both miniproc and native CL
;;; processes can be supported. This is used to test
;;; a miniproc implementation on an MP version of lisp
;;; prior to moving it to a pure MINIPROC implementation.
;;;
(eval-when (compile load eval)
