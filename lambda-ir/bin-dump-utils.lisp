...
(defun dump-document-universe (document-universe stream)
  (with-slots (object-name documents tokens) document-universe
...
#-(or MCL allegro ecl clisp sbcl cormanlisp clozure-common-lisp)
(defun dump-one (thing filename &optional estimated-length)
  ;;; KAP in sbcl the package is called common-lisp not lisp
  ;;; No clue why the old name is used here
  ;;; Fix is at least for sbcl
